...
toolkit.registration()
        .subAgent((SubAgentProvider<ReActAgent>) manageAgentProvider::get,
...
| SessionPersistenceHook | 按<br>sessionId:agentName<br>分键持久化/恢复会话状态 |
...
- **禁止替用户回答：**需要用户确认时，需要调ask_user工具，而不是自己就偷偷的确认掉了
