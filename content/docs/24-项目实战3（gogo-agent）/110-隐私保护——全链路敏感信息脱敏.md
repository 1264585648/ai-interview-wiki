...
在我们的项目中，我们借助一个开源的脱敏框架（[https://github.com/houbb/sensitive](https://github.com/houbb/sensitive) ）实现了一个统一的脱敏工具类：SensitiveMasker，这里面把手机号、身份证号、apikey等的脱敏都包含了。
...
![image.png](assets/2346034f9a94.png)
