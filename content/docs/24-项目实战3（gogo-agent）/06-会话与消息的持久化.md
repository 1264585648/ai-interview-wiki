...
| 层 | 存什么 | 存哪里 | 谁读 | 掉电会怎样 |
| --- | --- | --- | --- | --- |
| **L1 业务会话/消息** | 给人看的逐字记录 | MySQL<br>chat_conversation/chat_message | 前端 | 不丢（永久） |
| **L2 Agent 对话记忆** | 给模型喂的上下文 | MySQL<br>agentscope_session | LLM | 不丢（会话级） |
...
![image.png](assets/6a0e10083174.png)
...
| --- | --- | --- | --- |
| Agent 对话记忆 | sessionId:agentName | memory_messages<br>等 | SessionPersistenceHook |
