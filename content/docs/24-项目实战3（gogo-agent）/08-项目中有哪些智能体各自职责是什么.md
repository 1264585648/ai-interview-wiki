...
| **分析层**<br>（前置、单轮） | QueryRewritingAgent | AgentBase | 多轮问题改写与指代消除 |
| --- | --- | --- | --- |
|  | IntentRecognitionAgent | AgentBase | 三层意图识别（规则/向量/LLM） |
| **协调层**<br>（编排） | MasterAgent | ReActAgent | 总入口，路由/多意图编排/结果整合 |
| **业务层**<br>（专业执行） | ItineraryManageAgent | ReActAgent | 行程单全生命周期管理 |
...
|  | SubjectiveAssessorAgent | AgentBase | 做行程的多维主观审核了 |

它们的协作链路是：

![](assets/fec5aff36905.png)
...
改方案了：[63-✅多维行程审核架构的方案设计.md?spm=a2cl9.thoughts_devops2020_goldlog_.0.0.2d4469ffsOnPeb](63-✅多维行程审核架构的方案设计.md?spm=a2cl9.thoughts_devops2020_goldlog_.0.0.2d4469ffsOnPeb)
