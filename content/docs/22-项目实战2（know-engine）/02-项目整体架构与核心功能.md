...
![](assets/700c3dbc7743.png)

整体架构分层

系统采用**分层架构**设计，自上而下分为 5 层：

![](assets/9cae87dfe6a1.png)

知识入库流程

文档从上传到可检索的完整链路：

![](assets/505b4abbbc05.png)

对话流程

用户提问到获取回答的完整链路：

![](assets/6e59a33aa93e.png)

模块划分

项目源码按职责划分为 7 个核心包：

![](assets/22e30bd82b67.png)
...
来源: https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/69bfa9f0d31fed000134153c
