...
![image.png](assets/c9356f0df873.png)
...
public class MarkdownProcessServiceImpl extends MinerUProcessBaseServiceImpl {
     ...
     * 例如：<img src="https://xxx/foo.jpg" alt="image" /> -> <img src="https://xxx/foo.jpg" alt="这是一张xxx图片，xxx描述" />
     */
    private String enrichImageDescriptions(String mdContent) {
        ...
        while (matcher.find()) {
            ...
            String newImageTag = "`[图片: " + description + "]`";
