...
这个版本的提示词主要用到了角色定义，和fewshot等提示词工程的方案，但是实际使用过程中，发现意图识别的结果并不是特别的准确。经常会出现识别错误的情况。
...
4、没有shot示例，只有输出格式示例，没有输入输出配对示例。模型不知道"好"的输出长什么样，容易格式混乱或推理不充分。
...
```json
&#123;
    "reasoning": "1.相关性：涉及保修期，与汽车相关。2.场景：用户处于了解车辆政策阶段。3.辨析：询问保修期属于售前或售后政策咨询，归为售前咨询与购买。-> 售前咨询与购买",
    "related": true,
    "intent": "售前咨询与购买",
    "entities": &#123;
        "car_model": null,
...
```json
&#123;
    "reasoning": "用户询问了关于车的保修期，这与汽车相关，属于售后维修与保养类别中的保修政策咨询。没有提到具体车型或其他信息。",
    "related": true,
    "intent": "售后维修与保养",
    "entities": &#123;
        "car_model": null,
...
```json
&#123;
    "reasoning": "1.相关性：涉及价格，与汽车购买或优惠政策相关。2.场景：用户关注价格优惠。3.辨析：明确询问‘便宜点’，属于营销政策咨询。-> 汽车营销政策",
    "related": true,
    "intent": "汽车营销政策",
    "entities": &#123;
        "car_model": null,
...
```json
&#123;
    "reasoning": "用户提到‘价格能便宜点吗’，虽然未明确提及汽车，但结合上下文可能与购车或汽车相关服务的价格优惠有关，因此判断为汽车相关。意图属于‘售前咨询与购买’中的价格/优惠询问。未提及具体车型或其他关键信息。",
    "related": true,
    "intent": "售前咨询与购买",
    "entities": &#123;
        "car_model": null,
...
来源: https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/69df982774e40300017076ba
