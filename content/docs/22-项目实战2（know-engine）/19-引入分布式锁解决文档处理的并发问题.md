...
**这个其实是个低并发场景，为什么选择分布式锁这种悲观锁呢？**因为悲观锁还有个特点，是先加锁，后干活。乐观锁是先干活，最后再加锁。而我们的文档处理，很多时候都是先做转换（调mineru）、分段、嵌入等操作，最后在操作数据库的。如果最后加乐观锁，那么前面的并发还是发生了的，而这些操作是比较耗费资源的，所以悲观锁更合适。
...
来源: https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/69cd0d6174e403000160fd08
